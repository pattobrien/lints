...
//     return Container(
//       margin: EdgeInsets.all(1.000000000), // lint
//       child: Container(
//         color: Colors.red,
//         margin: EdgeInsets.all(Values.one.val), // no lint
...
//   const Example({super.key, this.isValue = false});
//   //
...
//         child: Container(
//           height: 100,
//           color: isValue ? Color(0x000) : Colors.red,
//           width: 100,
